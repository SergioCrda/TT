...
while($asig_salas3 = mysqli_fetch_assoc($asig_salas2)) {
    ...
    if($asig_salas3["ID_seccion_asignacion"] != "" || $asig_salas3["ID_seccion_asignacion"] != null) {
        ...
        $nombre2 = mysqli_query($link, $nombre1) or die('Consulta fallida $nombre2: '.mysqli_error($link).$nombre1);
...
header('Content-Disposition: attachment;filename="AsignacionSalas.xls"');
