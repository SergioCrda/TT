...
<html>
	...
	<body>
		...
		<?php
            ...
            $PDI1 = "SELECT * FROM `PDI` WHERE `ID_profesor` = '1' AND `Estado_PDI` = 1";
            ...
            while($fila = mysqli_fetch_assoc($PDI2)){
                ...
                echo "<option value='2'>Aprobar (Enviar a VRAC)</option>";
				echo "</select>";
                echo '</td>';
                ...
                while($seleccionRamoPDI3 = mysqli_fetch_assoc($seleccionRamoPDI2)){
                    $cuenta1++;
                    echo "<br>";
                    echo '<table align="center" width="800px" border="1" cellpadding="3" cellspacing="0" id="pdfTablaRamos'.$cuenta1.'"><tr class="titulo_fila"><td>N&deg; Ramo</td><td>C&oacute;d. de Ramo</td><td>Nombre del Ramo</td><td>Secciones</td></tr>';
                    echo "<tr class='centro'>";
